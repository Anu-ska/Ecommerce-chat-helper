      ...
      async ({ query, n = 10 }) => {
        try {
          ...
          const vectorStore = new MongoDBAtlasVectorSearch(
            ...
            // Cast to any to avoid type incompatibilities between different mongodb package instances
            dbConfig as any
          )
...
Current time: {time}`,
    ...
    // Cast client to any to avoid type mismatch between different mongodb package instances
